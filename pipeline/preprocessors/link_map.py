...
LINK_MAPS: list[LinkMap] = [
    {
        ...
        "links": {
            ...
            # Text splitters
            "CharacterTextSplitter": "langchain/text_splitters/#langchain.text_splitter.CharacterTextSplitter",
            "RecursiveCharacterTextSplitter": "langchain/text_splitters/#langchain.text_splitter.RecursiveCharacterTextSplitter",
            "TokenTextSplitter": "langchain/text_splitters/#langchain.text_splitter.TokenTextSplitter",
            # Runnables
            ...
            "langgraph.runtime.Runtime": "langgraph/runtime/#langgraph.runtime.Runtime",
    ...
    },
    {
        ...
        "links": {
            ...
            "ToolCallChunk": "types/_langchain_core.messages.ToolCallChunk.html",
            "ContentBlock": "types/_langchain_core.messages.ContentBlock.html",
            ...
            "on_llm_new_token": "classes/_langchain_core.callbacks_base.BaseCallbackHandler.html#handleLLMNewToken",
            ...
            "VectorStore.max_marginal_relevance_search": "classes/_langchain_core.vectorstores.VectorStore.html#maxMarginalRelevanceSearch",
            "Retrievers": "classes/_langchain_core.retrievers.BaseRetriever.html",
            # Text splitters
